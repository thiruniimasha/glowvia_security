        ...
        <div className="mt-12">
            ...
            <div>
                ...
                <div className="flex flex-col items-center mt-20">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3 md:gap-6 lg:grid-cols-4 xl:grid-cols-5 mt-6 w-full">
                        {relatedProducts.filter((product)=>product.inStock).map((product,index)=>(
                            <ProductCard key={index} product={product}/>
                        ))}
                    </div>

                    <button onClick={()=> {navigate('/products'); scrollTo(0,0)}} className="mx-auto curson-pointer px-12 my-16 py-2.5 border rounded text-primary hover:bg-primary/10 transition" >
                        See More
                    </button>
