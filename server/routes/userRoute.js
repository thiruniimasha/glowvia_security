...
import { isAuth, getUserProfile, updateUserProfile } from '../controllers/userController.js';
...
userRouter.put('/profile', authMiddleware, mapAuthToUser, updateUserProfile);
